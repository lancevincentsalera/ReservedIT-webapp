        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DayOfTheWeek>(entity =>
            {
                entity.HasKey(e => e.DayOfWeekId)
                    .HasName("PK__DayOfThe__01AA8DDF907951E8");
            ...
            modelBuilder.Entity<ImageGallery>(entity =>
            {
                entity.HasKey(e => e.ImageId)
                    .HasName("PK__ImageGal__7516F4EC43F9ED5C");
            ...
            modelBuilder.Entity<Permission>(entity =>
            {
                ...
                entity.HasIndex(e => e.PermissionName, "UQ__Permissi__0FFDA357B0F49DF3")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.RoleName, "UQ__Roles__8A2B61606A16631F")
                    .IsUnique();
            ...
            modelBuilder.Entity<RolePermission>(entity =>
            {
                entity.HasKey(e => e.RolePermissionsId)
                    .HasName("PK__RolePerm__18B281804A9177F5");
            ...
            modelBuilder.Entity<Room>(entity =>
            {
                ...
                entity.HasIndex(e => e.RoomName, "UQ__Room__6B500B5505E6B51D")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Email, "UQ__Users__A9D10534B7CF8E8A")
                    .IsUnique();
