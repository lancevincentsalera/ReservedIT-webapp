        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DayOfTheWeek>(entity =>
            {
                entity.HasKey(e => e.DayOfWeekId)
                    .HasName("PK__DayOfThe__01AA8DDFEA82AB69");
            ...
            modelBuilder.Entity<ImageGallery>(entity =>
            {
                entity.HasKey(e => e.ImageId)
                    .HasName("PK__ImageGal__7516F4ECC1F10C60");
            ...
            modelBuilder.Entity<Room>(entity =>
            {
                ...
                entity.HasIndex(e => e.RoomName, "UQ__Room__6B500B55C653AA34")
                    .IsUnique();
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__User__A9D10534D2C60C41")
                    .IsUnique();
