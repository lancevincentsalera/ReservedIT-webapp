        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DayOfTheWeek>(entity =>
            {
                entity.HasKey(e => e.DayOfWeekId)
                    .HasName("PK__DayOfThe__01AA8DDFB64E11C2");
            ...
            modelBuilder.Entity<ImageGallery>(entity =>
            {
                entity.HasKey(e => e.ImageId)
                    .HasName("PK__ImageGal__7516F4EC602C3633");
            ...
            modelBuilder.Entity<Permission>(entity =>
            {
                ...
                entity.HasIndex(e => e.PermissionName, "UQ__Permissi__0FFDA357C2AF82BA")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.RoleName, "UQ__Roles__8A2B6160B7E39AE9")
                    .IsUnique();
            ...
            modelBuilder.Entity<RolePermission>(entity =>
            {
                entity.HasKey(e => e.RolePermissionsId)
                    .HasName("PK__RolePerm__18B281802A41FCCC");
            ...
            modelBuilder.Entity<Room>(entity =>
            {
                ...
                entity.HasIndex(e => e.RoomName, "UQ__Room__6B500B55DC880210")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Email, "UQ__Users__A9D10534D95174CB")
                    .IsUnique();
